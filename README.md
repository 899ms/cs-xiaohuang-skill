...
> 把文章、课程笔记、产品说明或一个想法，做成一套由小黄解释的中文轻手绘 PPT-style 页面图。
>
> 16:9 标准页面｜可选 21:9 封面｜PNG 输出｜统一小黄身份｜适合知识内容、教学和产品讲解

## 这是什么

小黄 PPT 是一个 Codex Skill。它会先理解内容、建立叙事和逐页 blueprint，再把每页生成一张可直接交付的 PNG 视觉页面。
...
- 用户需要时的 21:9 PNG 封面（推荐 2520×1080）
- 多页 contact sheet
- 简短 slide-by-slide blueprint
...
3. 用语义选择“对比、转化、筛选、阻塞、分叉、循环、搭建、总结”等页面结构。
4. 锁定同一套角色身份、画布、标题、页码、线条、颜色与留白。
5. 为每页输出精准的图像 brief 和 `Required text only`。
6. 逐页生成并校验：中文、比例、身份、构图和风格。
7. 生成 contact sheet，修复不一致页面后交付。
